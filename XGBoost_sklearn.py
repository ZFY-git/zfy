...
# define model
model = xgb.XGBClassifier(max_depth=5, n_estimators=50, silent=True, objective='multi:softmax', feature_names=feature_name, num_class=2, booster='gbtree')

# train
model.fit(X_train, y_train, eval_metric='mlogloss', verbose=True, eval_set=evalset)
